...
Os motores bipolares basicamente não possuem o \emph{center-tape}, logo há duas bobinas em serie por fase. A grande vantagem deste tipo de motor é o maior torque em relação ao motor unipolar. A Fig. \ref{fig:MotorDePassoBipolar} apresenta o diagrama de um motor de passo bipolar.
...
Para que se possa comparar os tipos de acionamento da Tabela \ref{Table:AcionamentoUnipolar} e da Tabela \ref{Table:AcionamentoBipolar} segue abaixo um comparativo de características:
