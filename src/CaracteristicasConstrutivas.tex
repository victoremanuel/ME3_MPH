...
As principais partes constituintes de um HSM comercial é mostrado na Figura \ref{fig:partes_SM}.
	...
	%Alterar imagem 10 das partes constituintes do HSM: Tirar magnético e por imã, trocar rotor laminado por: (Rotor laminado - Seção Norte) e (Rotor laminado - Seção Sul).